...
// Alto credentials from environment
...
// Middleware to check proxy secret
...
// Make authenticated request to Alto
async function fetchFromAlto(url, token) {
  // CRITICAL FIX: Use token with colon, then base64
